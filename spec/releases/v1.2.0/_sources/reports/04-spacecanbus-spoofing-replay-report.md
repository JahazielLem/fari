...
|---|---|---|
| SPARTA [`EX-0014.02 Bus Traffic Spoofing`](https://sparta.aerospace.org/technique/EX-0014/02/) | Confirmed in lab scope | The injection uses an internal-bus identifier to make forged data appear to originate from a represented node |
| SPARTA [`EX-0001.02 Bus Traffic Replay`](https://sparta.aerospace.org/technique/EX-0001/02/) | Confirmed for transmission; candidate for receiver effect | The replay tool retransmits previously captured internal-bus frames |
| SPARTA [`DE-0002.03 Inhibit Spacecraft Functionality`](https://sparta.aerospace.org/technique/DE-0002/03/) | Candidate | Applicable only if misleading or stale values inhibit spacecraft functionality; that effect is not demonstrated |
| SPARTA [`REC-0005.01 Uplink Intercept Eavesdropping`](https://sparta.aerospace.org/technique/REC-0005/01/) | Not selected | The evidence shows a local replay file, not interception of an uplink |
