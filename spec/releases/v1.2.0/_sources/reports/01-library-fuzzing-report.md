...
- The evidence producer proposes SPARTA `EX-0005.01 Design Flaws`.
...
|---|---|---|
| SPARTA [`EX-0009 Exploit Code Flaws`](https://sparta.aerospace.org/technique/EX-0009/) | Confirmed | The supplied evidence directly demonstrates execution of unintended behavior through code flaws |
| SPARTA [`EX-0009.01 Flight Software`](https://sparta.aerospace.org/technique/EX-0009/01/) | Candidate | Appropriate if the library is integrated into flight software; integration placement is not supplied |
| SPARTA [`EX-0005.01 Design Flaws`](https://sparta.aerospace.org/technique/EX-0005/01/) | Not selected | The supplied evidence concerns software memory safety, not a demonstrated hardware or FPGA/ASIC design flaw |
