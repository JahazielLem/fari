...
### Optional SBOM inventory

- SBOM document ID: `[SBM-...]`
- Related asset: `[AST-...]`
- Format: `[cyclonedx | spdx | package-lock | text-list]`
- Component ID: `[CMP-...]`
...
- [ ] SBOM and inventory state are updated when relevant to the scope.
